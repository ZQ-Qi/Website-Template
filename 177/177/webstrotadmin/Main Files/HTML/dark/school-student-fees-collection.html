...
<head>
    ...
    <title>Webstrot Admin : Student Fees Collection </title>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Collection Fees</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card alert">
                                <div class="card-header pr">
                                    <h4>Collection Fees</h4>
                                    <div class="search-action">
                                        <div class="search-type dib">
                                            <input class="form-control input-rounded" placeholder="#Roll type here..." type="text">
                                        </div>
                                        <div class="search-type dib">
                                            <input class="form-control input-rounded" placeholder="Phone number..." type="text">
                                        </div>
                                        <div class="search-type dib">
                                        ...
                                        <table class="table student-data-table m-t-20">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$2400</td>
                                                    <td>
                                                        <span class="badge badge-warining">Pending</span>
                                                    </td>
                                                    <td>
                                                        +0098763
                                                    </td>
