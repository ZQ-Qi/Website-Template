...
@Component({
  selector: 'app-fixed-navbar-footer-layout',
  templateUrl: './fixed-navbar-footer-layout.component.html',
  styleUrls: ['./fixed-navbar-footer-layout.component.scss']
})
export class FixedNavbarFooterLayoutComponent implements OnDestroy, OnInit {
