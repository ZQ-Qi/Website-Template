    ...
    <div class="block block-fx-shadow">
        ...
        <div class="block-content block-content-full tab-content">
            <div class="tab-pane" id="crypto-coins-btc">
                ...
                <hr class="my-30">
                <div>
                    <!-- Bitcoin Chart.js Container (initialized in js/pages/be_pages_crypto_dashboard.js), for more examples you can check out http://www.chartjs.org/docs/ -->
            ...
            <div class="tab-pane" id="crypto-coins-eth">
                ...
                <hr class="my-30">
                <div>
                    <!-- Ethereum Chart.js Container (initialized in js/pages/be_pages_crypto_dashboard.js), for more examples you can check out http://www.chartjs.org/docs/ -->
            ...
            <div class="tab-pane" id="crypto-coins-ltc">
                ...
                <hr class="my-30">
                <div>
                    <!-- Litecoin Chart.js Container (initialized in js/pages/be_pages_crypto_dashboard.js), for more examples you can check out http://www.chartjs.org/docs/ -->
...
<!-- Page JS Code -->
<?php $cb->get_js('js/pages/be_pages_crypto_dashboard.js'); ?>
