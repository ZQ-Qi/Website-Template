        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Tooltip & Popover</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item">Ui Element</li>
                        <li class="breadcrumb-item active">Tooltip & Popover</li>
                    </ol>
                </div>
                <div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body bd-example-tooltip-static">
                                <h4 class="card-title">Static demo</h4>
                                <h6 class="card-subtitle">Four options are available: top, right, bottom, and left aligned. <code>data-toggle="tooltip" title="Default tooltip"</code></h6>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body bd-example-popover-static">
                                <h4 class="card-title">Static popover</h4>
