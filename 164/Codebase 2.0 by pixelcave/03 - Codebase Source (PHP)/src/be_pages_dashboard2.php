...
<div class="content">
    ...
    <div class="row row-deck gutters-tiny invisible" data-toggle="appear">
        <!-- Row #2 -->
        <div class="col-xl-4">
            <a class="block block-transparent bg-image d-flex align-items-stretch" href="javascript:void(0)" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo24@2x.jpg');">
        ...
        <div class="col-sm-6 col-xl-4">
            <a class="block block-transparent bg-image d-flex align-items-stretch" href="javascript:void(0)" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo32@2x.jpg');">
        ...
        <div class="col-sm-6 col-xl-4">
            <a class="block block-transparent bg-image d-flex align-items-stretch" href="javascript:void(0)" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo10@2x.jpg');">
    ...
    <div class="row gutters-tiny invisible" data-toggle="appear">
        ...
        <div class="col-xl-8 d-flex align-items-stretch">
            <div class="block block-themed block-mode-loading-inverse block-transparent bg-image w-100" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo34@2x.jpg');">
