...
<div class="content">
    ...
    <!-- Ripple Effect -->
    <!-- Ripple functionality ([data-toggle="click-ripple"] is initialized in Codebase() -> uiHelperCoreRipple()) -->
    <div class="block">
        <div class="block-header block-header-default">
            ...
            <div class="row items-push">
                ...
                <div class="col-12">
                    ...
                    <div class="btn-toolbar push" role="toolbar" aria-label="Toolbar with button groups">
                        ...
                        <div class="btn-group btn-group-sm" data-toggle="buttons" role="group" aria-label="Second group">
                            <button type="button" class="btn btn-secondary">
                                <i class="fa fa-bold"></i>
                            </button>
                            <button type="button" class="btn btn-secondary">
                    ...
                    <div class="btn-toolbar" role="toolbar">
                        ...
                        <div class="btn-group btn-group-lg" data-toggle="buttons" role="group" aria-label="Second group">
                            <button type="button" class="btn btn-secondary">
                                <i class="fa fa-bold"></i>
                            </button>
                            <button type="button" class="btn btn-secondary">
