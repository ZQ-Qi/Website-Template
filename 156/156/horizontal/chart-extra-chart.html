        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Extra Charts</h3>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row m-t-40">
                                    ...
                                    <div class="col-lg-2 col-md-6 m-b-30">
                                        <div class="chart easy-pie-chart-1" data-percent="75"> <span><img src="../assets/images/users/1.jpg" alt="user" class="img-circle"/></span> </div>
                                    </div>
                                    <div class="col-lg-2 col-md-6 m-b-30">
                                        <div class="chart easy-pie-chart-2" data-percent="75"> <span><img src="../assets/images/users/2.jpg" alt="user"  class="img-circle"/></span> </div>
                                    </div>
                                    <div class="col-lg-2 col-md-6 m-b-30">
                                        <div class="easy-pie-chart-3 chart" data-percent="25"> <span><img src="../assets/images/users/3.jpg" alt="user" class="img-circle"/></span> </div>
                                    </div>
                                    <div class="col-lg-2 col-md-6 m-b-30">
                                        <div class="chart easy-pie-chart-4" data-percent="75"> <span><img src="../assets/images/users/4.jpg" alt="user" class="img-circle"/></span> </div>
                                    </div>
                                    <div class="col-lg-2 col-md-6 m-b-30">
                                        <div class="chart easy-pie-chart-5" data-percent="75"> <span><img src="../assets/images/users/5.jpg" alt="user" class="img-circle"/></span> </div>
                                    </div>
                                    <div class="col-lg-2 col-md-6">
                                        <div class="easy-pie-chart-6 chart" data-percent="25"> <span><img src="../assets/images/users/6.jpg" alt="user"  class="img-circle"/></span> </div>
                                    </div>
                                </div>
                                <div class="row m-t-40">
                                    <div class="col-12">
