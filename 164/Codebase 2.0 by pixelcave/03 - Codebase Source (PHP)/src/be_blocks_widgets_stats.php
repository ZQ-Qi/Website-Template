...
<div class="content">
    ...
    <div class="row gutters-tiny">
        ...
        <div class="col-md-6 col-xl-3">
            <a class="block block-transparent" href="javascript:void(0)">
                <div class="block-content block-content-full text-right bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo26.jpg');">
        ...
        <div class="col-md-6 col-xl-3">
            <a class="block block-transparent" href="javascript:void(0)">
                <div class="block-content block-content-full text-right bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo28.jpg');">
                    <div class="py-50 text-center bg-black-op-25">
    ...
    <div class="row gutters-tiny">
        <!-- Row #3 -->
        <div class="col-md-6">
            <div class="block block-transparent bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo13.jpg');">
        ...
        <div class="col-md-6">
            <div class="block block-transparent bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo22.jpg');">
    ...
    <!-- Chart.js Charts (initialized in js/pages/be_blocks_widgets_stats.js), for more examples you can check out http://www.chartjs.org/docs/ -->
    ...
    <div class="row gutters-tiny">
        <!-- Row #2 -->
        <div class="col-md-6">
            <div class="block block-transparent bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo23@2x.jpg');">
        ...
        <div class="col-md-6">
            <div class="block block-transparent bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo27@2x.jpg');">
...
<!-- Page JS Code -->
<?php $cb->get_js('js/pages/be_blocks_widgets_stats.js'); ?>
<script>
    jQuery(function(){
