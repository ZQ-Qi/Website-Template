    ...
    <div class="block">
        <div class="block-content">
            <div class="row items-push">
                <div class="col-xl-8">
                    <div>
                        <img id="js-img-cropper" class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/photos/photo22@2x.jpg" alt="photo">
                    </div>
                </div>
                <div class="col-xl-4">
...
<!-- Page JS Code -->
<?php $cb->get_js('js/pages/be_comp_image_cropper.js'); ?>
