...
<div class="content">
    ...
    <div class="row items-push js-gallery img-fluid-100">
        ...
        <div class="col-md-6 col-lg-4 col-xl-3 animated fadeIn">
            <a class="img-link img-link-zoom-in img-thumb img-lightbox" href="<?php echo $cb->assets_folder; ?>/img/photos/photo<?php echo $i; ?>@2x.jpg">
            ...
            <div class="options-container fx-item-zoom-in fx-overlay-slide-down">
                ...
                <div class="options-overlay bg-black-op-75">
                    <div class="options-overlay-content">
                        ...
                        <a class="btn btn-sm btn-rounded btn-noborder btn-alt-primary min-width-75 img-lightbox" href="<?php echo $cb->assets_folder; ?>/img/photos/photo<?php echo $i; ?>@2x.jpg">
