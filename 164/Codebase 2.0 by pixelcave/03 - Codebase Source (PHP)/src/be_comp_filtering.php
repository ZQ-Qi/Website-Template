    ...
    <div class="js-filter" data-numbers="true">
        ...
        <div class="row items-push">
            <div class="col-md-6 col-lg-4 col-xl-3" data-category="mountains">
                <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/photos/photo1.jpg" alt="">
            </div>
            <div class="col-md-6 col-lg-4 col-xl-3" data-category="mountains">
                <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/photos/photo2.jpg" alt="">
            </div>
            <div class="col-md-6 col-lg-4 col-xl-3" data-category="water">
                <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/photos/photo3.jpg" alt="">
            </div>
            <div class="col-md-6 col-lg-4 col-xl-3" data-category="nature">
                <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/photos/photo5.jpg" alt="">
            </div>
            <div class="col-md-6 col-lg-4 col-xl-3" data-category="mountains">
                <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/photos/photo6.jpg" alt="">
            </div>
            <div class="col-md-6 col-lg-4 col-xl-3" data-category="nature">
                <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/photos/photo8.jpg" alt="">
            </div>
            <div class="col-md-6 col-lg-4 col-xl-3" data-category="water">
                <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/photos/photo9.jpg" alt="">
            </div>
            <div class="col-md-6 col-lg-4 col-xl-3" data-category="nature">
                <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/photos/photo11.jpg" alt="">
            </div>
            <div class="col-md-6 col-lg-4 col-xl-3" data-category="nature">
                <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/photos/photo13.jpg" alt="">
            </div>
            <div class="col-md-6 col-lg-4 col-xl-3" data-category="mountains">
                <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/photos/photo21.jpg" alt="">
            </div>
            <div class="col-md-6 col-lg-4 col-xl-3" data-category="mountains">
                <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/photos/photo22.jpg" alt="">
            </div>
            <div class="col-md-6 col-lg-4 col-xl-3" data-category="nature">
                <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/photos/photo23.jpg" alt="">
            </div>
        </div>
    </div>
