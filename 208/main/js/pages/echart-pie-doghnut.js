        ...
        var option = {
            // Add title
                ...
                legend: {
                    ...
                    x: 'left',
                    y: 'bottom',
                    data: ['Direct', 'Mail', 'Ads', 'Video', 'Search Engine']
                },

                // Add custom colors
                color: ['#0bb2d4', '#17b3a3', '#3e8ef7', '#ffd600', '#ff4c52'],
    ...
    // based on prepared DOM, initialize echarts instance
        ...
        var option = {
           ...
           tooltip: {
                ...
                legend: {
                    ...
                    x: 'left',
                    y: 'bottom',
                    data: ['Direct','Marketing','Search','Mail','Ads','Video','Baidu','Google','Bing','Other']
                },
        ...
        // based on prepared DOM, initialize echarts instance
            ...
            var option = {
                ...
                color: ['#0bb2d4', '#e4eaec', '#17b3a3', '#3e8ef7', '#ffd600', '#ff4c52'],
