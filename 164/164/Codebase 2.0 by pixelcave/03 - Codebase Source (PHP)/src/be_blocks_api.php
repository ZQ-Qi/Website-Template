...
<!-- Page Content -->
<div class="content">
    <!-- Blocks API, functionality initialized in Codebase() -> uiApiBlocks() -->
    ...
    <!-- Interactivity, functionality initialized in Codebase() -> uiApiBlocks() -->
    <!-- In fullscreen and content toggle buttons, icon classes are auto added from Codebase() -> uiApiBlocks() -->
