...
<div class="content">
    <!-- Tooltips -->
    <!-- Bootstrap Tooltip (data-toggle="tooltip" and .js-tooltip class is initialized in Codebase() -> uiHelperCoreTooltip()) -->
    <!-- For advanced poover usage you can check out https://getbootstrap.com/docs/4.0/components/tooltips/ -->
    ...
    <!-- Popovers -->
    <!-- Bootstrap Popover (data-toggle="popover" and .js-popover class is initialized in Codebase() -> uiHelperCorePopover()) -->
    <!-- For advanced poover usage you can check out https://getbootstrap.com/docs/4.0/components/popovers/ -->
    ...
    <!-- Bootstrap Modals -->
    <!-- For advanced modal usage you can check out https://getbootstrap.com/docs/4.0/components/modal/ -->
    ...
    <!-- For all modal methods you can check out https://getbootstrap.com/docs/4.0/components/modal/#via-javascript -->
