  ...
  "main": [
    {
      ...
      var myChart = new xChart('bar', data, '#xchart-bars');
...
(function () {
  ...
  "tickFormatX": function (x) { return d3.time.format('%A')(x); }
      ...
      var myChart = new xChart('line', data, '#xchart-line', opts);
...
document.body.appendChild(tt);
  ...
  "mouseout": function (x) {
    $(tt).hide();
      ...
      var myChart = new xChart('line-dotted', data, '#xchart-points', opts);
...
(function () {
      ...
      var myChart = new xChart('bar', data[0], '#xchart-errorBars'),
        i = 0;
