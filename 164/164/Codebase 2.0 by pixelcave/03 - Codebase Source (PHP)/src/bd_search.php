...
<div class="content">
    <!-- Search -->
    <form class="push" action="bd_search.php" method="post">
            ...
            <div class="tab-pane fade" id="search-photos" role="tabpanel">
                ...
                <div class="row gutters-tiny">
                    <div class="col-md-6 col-lg-4 push">
                        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/photos/photo1.jpg" alt="">
                    </div>
                    <div class="col-md-6 col-lg-4 push">
                        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/photos/photo2.jpg" alt="">
                    </div>
                    <div class="col-md-6 col-lg-4 push">
                        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/photos/photo6.jpg" alt="">
                    </div>
                    <div class="col-md-6 col-lg-4 push">
                        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/photos/photo21.jpg" alt="">
                    </div>
                    <div class="col-md-6 col-lg-4 push">
                        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/photos/photo22.jpg" alt="">
                    </div>
                    <div class="col-md-6 col-lg-4 push">
                        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/photos/photo9.jpg" alt="">
                    </div>
                    <div class="col-md-6 col-lg-4 push">
                        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/photos/photo23.jpg" alt="">
                    </div>
                    <div class="col-md-6 col-lg-4 push">
                        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/photos/photo24.jpg" alt="">
                    </div>
                    <div class="col-md-6 col-lg-4 push">
                        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/photos/photo25.jpg" alt="">
                    </div>
                </div>
            </div>
            <!-- END Photos -->
