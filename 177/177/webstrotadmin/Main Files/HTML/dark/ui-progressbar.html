...
<head>
    ...
    <title>Webstrot Admin : Progress Bar</title>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">UI-Progressbar</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card alert">
                                ...
                                <div class="basic-progressbar">
                                    <p class="muted m-b-15">To create a default progress bar, add a <code>.progress</code> class to a <code>&lt;div&gt;</code> element:</p>
                                    <div class="progress">
                                        <div class="progress-bar w-70" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
                        ...
                        <div class="col-lg-6">
                            <div class="card alert">
                                ...
                                <div class="basic-progressbar">
                                    <p class="muted m-b-15">Remove the <code>.sr-only</code> class from the progress bar to show a visible percentage:</p>
                                    <div class="progress">
                                        <div class="progress-bar w-70" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
                                            70%
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card alert">
                                ...
                                <div class="basic-progressbar">
                                    <p class="muted m-b-15">The contextual classes that can be used with progress bars are <code>.progress-bar-primary</code>, <code>.progress-bar-success</code>, <code>.progress-bar-info</code>, <code>.progress-bar-danger</code>,</p>
                                    <div class="progress">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-info w-50" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                                            50% Complete (info)
                                        </div>
                                    </div>
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-danger w-70" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
                                            70% Complete (danger)
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card alert">
                                ...
                                <div class="basic-progressbar">
                                    <p class="muted m-b-15">Add class <code>.progress-bar-striped</code> to add stripes to the progress bars:</p>

                                    <div class="progress">
                                        <div class="progress-bar progress-bar-primary progress-bar-striped w-40" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">
                                            40% Complete (primary)
                                        </div>
                                    </div>

                                    <div class="progress">
                                        <div class="progress-bar progress-bar-success progress-bar-striped w-40" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">
                                            40% Complete (success)
                                        </div>
                                    </div>

                                    <div class="progress">
                                        <div class="progress-bar progress-bar-info progress-bar-striped w-50" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                                            50% Complete (info)
                                        </div>
                                    </div>

                                    <div class="progress">
                                        <div class="progress-bar progress-bar-warning progress-bar-striped w-60" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
                                            60% Complete (warning)
                                        </div>
                                    </div>

                                    <div class="progress">
                                        <div class="progress-bar progress-bar-danger progress-bar-striped w-70" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
                                            70% Complete (danger)
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card alert">
                                ...
                                <div class="basic-progressbar">
                                    <p class="muted m-b-15">Add class <code>.active</code> to animate the progress bar:</p>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-primary progress-bar-striped active w-40" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">
                                            40%
                                        </div>
                                    </div>
                                    <div class="progress">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-info progress-bar-striped active w-50" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                                            50%
                                        </div>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-warning progress-bar-striped active w-60" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
                                            60%
                                        </div>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-danger progress-bar-striped active w-70" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
                                            70%
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card alert">
                                ...
                                <div class="basic-progressbar">
                                    <p class="muted m-b-15">Create a stacked progress bar by placing multiple bars into the same <code class="w3-codespan">&lt;div class="progress"&gt;</code>:</p>

                                    <div class="progress">
                                        <div class="progress-bar progress-bar-success w-40" role="progressbar">
                                            Free Space
                                        </div>
                                        <div class="progress-bar progress-bar-warning w-10" role="progressbar">
                                            Warning
                                        </div>
                                        <div class="progress-bar progress-bar-danger w-20" role="progressbar">
                                            Danger
                                        </div>
                                    </div>
                                </div>
