...
<!-- Page loader (functionality is initialized in Codebase() -> uiHelperCorePageLoader()) -->
...
<div class="content">
    ...
    <!-- Page Loader (functionality is initialized Codebase() -> uiHelperCorePageLoader()) -->
    ...
    <!-- Progress -->
    <!-- Randomize Values Buttons (.js-bar-randomize class is initialized in js/pages/be_ui_activity.js) -->
    <div class="row">
        <div class="col-xl-6">
            <!-- Progress Normal -->
            <div class="block">
    ...
    <!-- Bootstrap Notify (.js-notify class is initialized in Codebase() -> uiHelperNotify()) -->
    <div class="block">
        <div class="block-header block-header-default">
...
<?php $cb->get_js('js/plugins/sweetalert2/es6-promise.auto.min.js'); ?>
<?php $cb->get_js('js/plugins/sweetalert2/sweetalert2.min.js'); ?>

<!-- Page JS Code -->
<?php $cb->get_js('js/pages/be_ui_activity.js'); ?>
<script>
    jQuery(function(){
