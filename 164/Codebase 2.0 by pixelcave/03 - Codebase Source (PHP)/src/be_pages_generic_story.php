...
<!-- Page JS Plugins CSS -->
<?php $cb->get_css('js/plugins/magnific-popup/magnific-popup.min.css'); ?>

<?php require 'inc/_global/views/head_end.php'; ?>
<?php require 'inc/_global/views/page_start.php'; ?>

<!-- Hero -->
<div class="bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo27@2x.jpg');">
        ...
        <div class="col-lg-8">
            ...
            <div class="row no-gutters push js-gallery img-fluid-100">
                <div class="col-6 animated fadeIn">
                    <a class="img-link img-link-simple img-link-zoom-in img-lightbox" href="<?php echo $cb->assets_folder; ?>/img/photos/photo32@2x.jpg">
                        <?php $cb->get_photo(32, false, 'img-fluid'); ?>
                    </a>
                </div>
                <div class="col-6 animated fadeIn">
                    <a class="img-link img-link-simple img-link-zoom-in img-lightbox" href="<?php echo $cb->assets_folder; ?>/img/photos/photo31@2x.jpg">
                        <?php $cb->get_photo(31, false, 'img-fluid'); ?>
                    </a>
                </div>
                <div class="col-4 animated fadeIn">
                    <a class="img-link img-link-simple img-link-zoom-in img-lightbox" href="<?php echo $cb->assets_folder; ?>/img/photos/photo33@2x.jpg">
                        <?php $cb->get_photo(33, false, 'img-fluid'); ?>
                    </a>
                </div>
                <div class="col-4 animated fadeIn">
                    <a class="img-link img-link-simple img-link-zoom-in img-lightbox" href="<?php echo $cb->assets_folder; ?>/img/photos/photo30@2x.jpg">
                        <?php $cb->get_photo(30, false, 'img-fluid'); ?>
                    </a>
                </div>
                <div class="col-4 animated fadeIn">
                    <a class="img-link img-link-simple img-link-zoom-in img-lightbox" href="<?php echo $cb->assets_folder; ?>/img/photos/photo28@2x.jpg">
                        <?php $cb->get_photo(28, false, 'img-fluid'); ?>
                    </a>
                </div>
                <div class="col-6 animated fadeIn">
                    <a class="img-link img-link-simple img-link-zoom-in img-lightbox" href="<?php echo $cb->assets_folder; ?>/img/photos/photo25@2x.jpg">
                        <?php $cb->get_photo(25, false, 'img-fluid'); ?>
                    </a>
                </div>
                <div class="col-6 animated fadeIn">
                    <a class="img-link img-link-simple img-link-zoom-in img-lightbox" href="<?php echo $cb->assets_folder; ?>/img/photos/photo26@2x.jpg">
    ...
    <div class="content content-full">
        <div class="row justify-content-center py-30">
            <div class="col-lg-8">
                ...
                <div class="media mb-30">
                    <img class="img-avatar img-avatar48 d-flex mr-20" src="<?php echo $cb->assets_folder; ?>/img/avatars/avatar0.jpg" alt="">
                    <div class="media-body">
...
<!-- Page JS Plugins -->
<?php $cb->get_js('js/plugins/magnific-popup/magnific-popup.min.js'); ?>
