...
!function($) {
    ...
    FlotChart.prototype.createCombineGraph = function(selector, ticks, labels, datas) {
        ...
        FlotChart.prototype.init = function() {
          ...
          var datas = [20,30, 15];
          var colors = ['#ebc142', '#03a9f4', '#009688'];
          this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);


            //real time data representation
            var plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['#03a9f4']);
            plot.draw();
            var $this = this;
            function updatePlot() {
          ...
          var donutcolors = ['#ebc142', '#03a9f4', '#009688',"#2f353f","#1ca8dd"];
