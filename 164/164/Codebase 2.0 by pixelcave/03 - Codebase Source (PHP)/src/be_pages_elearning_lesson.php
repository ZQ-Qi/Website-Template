...
<!-- Hero -->
<div class="bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/various/landing-promo-developer-minded-html@2x.png');">
