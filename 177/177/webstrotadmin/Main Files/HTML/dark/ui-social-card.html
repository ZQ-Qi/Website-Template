...
<head>
    ...
    <title>Webstrot Admin : Social Card</title>
            ...
            <div class="container-fluid">
                ...
                <div id="main-content">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card-body">
                                <div class="user-bg-card pr bg-facebook text-center social-pad">
                                   <span><i class="ti-facebook f-s-40 color-white"></i> </span>
                                </div>
                                ...
                                <div class="social-connect text-center p-20">
                                    <ul>
                                        <li class="social-item p-10">
                                            <span class="f-s-30">4.4k</span><br>
                                            <span>Like</span>
                                        </li>
                                        <li class="social-item p-10">
                                            <span class="f-s-30">3045</span><br>
                                            <span>Followers</span>
                                        </li>
                                        <li class="social-item p-10">
                                            <span class="f-s-30">1038</span><br>
                                            <span>Follow</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="text-center p-b-30">
                                    <a class=" bg-facebook color-white bg-facebook p-10 dib" href="">
                                        <span class="p-10 border-right"><i class="ti-facebook"></i> </span>
                                        <span class="p-10">Follower</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="card-body">
                                <div class="user-bg-card pr bg-twitter text-center social-pad">
                                    <span><i class="ti-twitter f-s-40 color-white"></i> </span>
                                </div>
                                <div class="user-card-profile user-card-absolute round-img pa text-center">
                                    <img class="height-150" src="assets/images/user.jpg" alt="">
                                </div>
                                ...
                                <div class="text-center p-b-30">
                                    <a class=" bg-facebook color-white bg-twitter p-10 dib" href="">
                                        <span class="p-10 border-right"><i class="ti-twitter"></i> </span>
                                        <span class="p-10">Follower</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card-body">
                                <div class="user-bg-card pr bg-linkedin text-center social-pad">
                                    <span><i class="ti-linkedin f-s-40 color-white"></i> </span>
                                </div>
                                <div class="user-card-profile user-card-absolute round-img pa text-center">
                                    <img class="height-150" src="assets/images/user.jpg" alt="">
                                </div>
                                ...
                                <div class="text-center p-b-30">
                                    <a class=" bg-facebook color-white p-10 bg-linkedin dib" href="">
                                        <span class="p-10 border-right"><i class="ti-linkedin"></i> </span>
                                        <span class="p-10">Follower</span>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="testimonial-widget-one p-17">
                                    <div class="testimonial-widget-one owl-carousel owl-theme">
                                        <div class="item text-center">
                                            <div class="color-success m-b-30">
                                                <i class="ti-facebook f-s-30"></i>
                                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="testimonial-widget-one p-17">
                                    <div class="testimonial-widget-one owl-carousel owl-theme">
                                        <div class="item text-center">
                                            <div class="color-primary m-b-30">
                                                <i class="ti-twitter f-s-30"></i>
                                            </div>
                                            <div class="testimonial-content">
                                                <div class="testimonial-text text-center">
                                                    <i class="fa fa-quote-left"></i> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation <i class="fa fa-quote-right"></i>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="testimonial-widget-one p-17">
                                    <div class="testimonial-widget-one owl-carousel owl-theme">
                                        <div class="item text-center">
                                            <div class="color-info m-b-30">
                                                <i class="ti-linkedin f-s-30"></i>
                                            </div>
                                            <div class="testimonial-content">
                                                <div class="testimonial-text text-center">
                                                    <i class="fa fa-quote-left"></i> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation <i class="fa fa-quote-right"></i>
