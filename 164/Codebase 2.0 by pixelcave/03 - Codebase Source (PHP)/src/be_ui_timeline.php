            ...
            <ul class="list list-timeline pull-t">
                ...
                <li>
                    ...
                    <div class="list-timeline-content">
                        ...
                        <!-- Gallery (.js-gallery class is initialized in Codebase() -> uiHelperMagnific()) -->
                        <!-- For more info and examples you can check out http://dimsemenov.com/plugins/magnific-popup/ -->
                        <div class="row items-push js-gallery img-fluid-100">
                            <div class="col-sm-6 col-xl-3">
                                <a class="img-link img-link-zoom-in img-lightbox" href="<?php echo $cb->assets_folder; ?>/img/photos/photo2@2x.jpg">
                                    <?php $cb->get_photo(2, false, 'img-fluid'); ?>
                                </a>
                            </div>
                            <div class="col-sm-6 col-xl-3">
                                <a class="img-link img-link-zoom-in img-lightbox" href="<?php echo $cb->assets_folder; ?>/img/photos/photo8@2x.jpg">
                                    <?php $cb->get_photo(8, false, 'img-fluid'); ?>
                                </a>
                            </div>
                            <div class="col-sm-6 col-xl-3">
                                <a class="img-link img-link-zoom-in img-lightbox" href="<?php echo $cb->assets_folder; ?>/img/photos/photo9@2x.jpg">
                ...
                <li>
                    ...
                    <div class="list-timeline-content">
                        ...
                        <div class="row items-push js-gallery img-fluid-100">
                            <div class="col-sm-6 col-xl-3">
                                <a class="img-link img-link-zoom-in img-lightbox" href="<?php echo $cb->assets_folder; ?>/img/photos/photo4@2x.jpg">
                                    <?php $cb->get_photo(4, false, 'img-fluid'); ?>
                                </a>
                            </div>
                            <div class="col-sm-6 col-xl-3">
                                <a class="img-link img-link-zoom-in img-lightbox" href="<?php echo $cb->assets_folder; ?>/img/photos/photo18@2x.jpg">
