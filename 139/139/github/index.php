...
<head>
	...
	<meta charset="UTF-8">
	<title>Metronic - The Ultimate Bootstrap Admin Theme</title>
	...
	<section class="section section--header"><!-- section -->
				...
				<div class="header__handler">
					<div class="sidebar">
						...
						<ul class="sidebar__menu">
							<li class="sidebar__menu__item"><a href="../index.html">Live Preview</a></li>
							<li class="sidebar__menu__item"><a href="../faq.html">FAQ</a></li>
							<li class="sidebar__menu__item"><a href="../documentation.html">Documentation</a></li>
							<li class="sidebar__menu__item"><a href="https://keenthemes.com/metronic/github" target="_blank">Github Access</a></li>
							<li class="sidebar__menu__item"><a href="../reviews.html">Reviews</a></li>
							<li class="sidebar__menu__item"><a href="../changelog.html">Changelog</a></li>
							<li class="sidebar__menu__item">
								<a href="https://keenthemes.com/preview/metronic/" target="_blank">Old Metronic</a></li>
						</ul>
					</div>
		...
		<div class="content"><!-- content -->
			...
			<div class="intro"><!-- intro -->
				...
				<h2 class="intro__title">The Ultimate Bootstrap Admin Theme Framework For Next Generation Applications</h2>
			...
			<div class="main__menu_wrap"><!-- main__menu_wrap -->
				<ul class="main__menu">
					<li class="main__menu__item"><a href="../index.html">Live Preview</a></li>
					<li class="main__menu__item"><a href="../faq.html">FAQ</a></li>
					<li class="main__menu__item"><a href="../documentation.html">Documentation</a></li>
					<li class="main__menu__item active"><a href="https://keenthemes.com/metronic/github" target="_blank">Github Access</a></li>
					<li class="main__menu__item"><a href="../reviews.html">Reviews</a></li>
					<li class="main__menu__item"><a href="../changelog.html">Changelog</a></li>
					<li class="main__menu__item"><a href="https://keenthemes.com/preview/metronic/" target="_blank">Old Metronic</a></li>
				</ul>
			</div><!-- main__menu_wrap END -->
	...
	<section class="section section--white section--padding"><!-- section -->
		<div class="content">
			...
			<div class="contents"><!-- contents -->
				...
				<div class="contents__box" style="width:100%;">

					<form id="repo-register-form" autocomplete="off" method="post" action="" style="width: 500px; margin: 20px auto;">
						<div class="form-group" style="margin: 30px 0 40px 0">
							<h4>GitHub Access</h4>
						</div>

						<div class="form-group" style="margin: 0 0 20px 0">
							<p>
								Please fill up the below form with your existing Github username to receive an invitation to the Metronic's Github repository. You will be registered as a collaborator with following privileges:
							</p>
							<ul style="color: #7d8099;">
						...
						<div class="form-group">
							<div id="alert-message" style="display: none;" class="alert alert-danger" role="alert"></div>
						</div>
						...
						<div class="form-group">
							<label for="purchase-code" class="form-control-label m--font-bolder">Purchase Code:</label>
							<input type="text" class="form-control" id="purchase-code" name="purchase_code" placeholder="Enter your purchase code">
						</div>

						<div class="form-group" style="margin: 30px 0; color: #7d8099;">
							You are required to have a valid purchase code and active
							<a class="m-link" href="https://help.market.envato.com/hc/en-us/articles/207886473-Extending-and-Renewing-Item-Support" target="_blank">support subscription</a>.
							Click
							<a href="#" class="m-link m--font-bolder" data-toggle="modal" data-target="#where-purchase-code">here</a> to find your purchase code.
						</div>
						...
						<div class="form-group">
							<input class="btn button_purple" id="submit" type="submit" name="submit" value="Send My Invitation">
						</div>
					</form>

					<div class="modal fade" id="where-purchase-code" tabindex="-1" role="dialog" aria-labelledby="where-purchase-code-label" aria-hidden="true">
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="where-purchase-code-label">How to find your purchase code</h5>
								...
								<div class="modal-body">
									<ul class="nav nav-tabs m-tabs-line m-tabs-line--brand" role="tablist">
										<li class="nav-item m-tabs__item">
											<a class="nav-link m-tabs__link active" data-toggle="tab" href="#m_layout_builder_purchase_code_ver_step_1" role="tab">Step 1</a>
										</li>
										<li class="nav-item m-tabs__item">
											<a class="nav-link m-tabs__link" data-toggle="tab" href="#m_layout_builder_purchase_code_ver_step_2" role="tab">Step 2</a>
										</li>
									</ul>
									<div class="tab-content" style="padding: 20px 0; color: #666;">
										<div class="tab-pane active" id="m_layout_builder_purchase_code_ver_step_1">
											<p>The purchase confirmation code is available in the license certificate which you received once you made your purchase from Envato marketplaces. This is useful for registering the plugin for auto-updates, and also for gaining access to our support forum.</p>
											<p>
											...
											<p>Next, click the green download button, and then click "License certificate & purchase code (text)" as shown below.</p>
											<img src="img/screen1.jpg" alt="Download page" width="100%">
										</div>
										<div class="tab-pane" id="m_layout_builder_purchase_code_ver_step_2">
											<p>Next, open the text file, and inside, you’ll see the purchase code listed:</p>
											<img src="img/screen2.jpg" alt="Purchase code" width="100%">
										</div>
									</div>
								</div>
								<div class="modal-footer">
									<button type="button" class="btn button_purple" data-dismiss="modal">Close</button>
								</div>
							</div>
						</div>
					</div>
