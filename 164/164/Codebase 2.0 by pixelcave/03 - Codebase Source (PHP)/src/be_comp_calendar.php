...
<!-- Page Content -->
<div class="content">
    <!-- Calendar and Events functionality (initialized in js/pages/be_comp_calendar.js), for more info and examples you can check out http://fullcalendar.io/ -->
    <div class="block">
...
<!-- Page JS Code -->
<?php $cb->get_js('js/pages/be_comp_calendar.js'); ?>
