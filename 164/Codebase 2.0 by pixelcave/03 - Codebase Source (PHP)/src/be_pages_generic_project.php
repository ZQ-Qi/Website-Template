...
<div class="content">
    ...
    <div class="block">
            ...
            <div class="row py-20">
                <div class="col-sm-6 invisible" data-toggle="appear">
                    ...
                    <div class="js-slider slick-nav-black slick-dotted-inner slick-dotted-white" data-dots="true" data-arrows="true">
                        <div>
                            <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/various/cb-project-promo1.png" alt="Project Promo 1">
                        </div>
                        <div>
                            <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/various/cb-project-promo2.png" alt="Project Promo 2">
                        </div>
                        <div>
                            <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/various/cb-project-promo3.png" alt="Project Promo 3">
                        </div>
                    </div>
                    <!-- END Image Slider -->
        ...
        <!-- Testimonial -->
        <div class="bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo30@2x.jpg');">
