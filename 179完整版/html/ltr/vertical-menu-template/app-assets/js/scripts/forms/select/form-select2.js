...
(function(window, document, $) {
  ...
  // Basic Select2 select
    ...
    $(".js-programmatic-set-val").on("click", function () { $select.val("MS").trigger("change"); });
    ...
    $(".js-programmatic-multi-set-val").on("click", function () { $selectMulti.val(["NM", "IN","VA"]).trigger("change"); });
    $(".js-programmatic-multi-clear").on("click", function () { $selectMulti.val(null).trigger("change"); });

    // Loading array data
    var data = [
        { id: 0, text: 'Array Element 1' },
        { id: 1, text: 'Array Element 2' },
        { id: 2, text: 'Array Element 3' },
        { id: 3, text: 'Array Element 4' },
        { id: 4, text: 'Array Element 5' }
    ];
