        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Linea icon</h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Use <code>linea-basic</code> class like :<code> &lt;div data-icon="a" class="linea-icon linea-basic"&gt;&lt;div&gt; </code></h6>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Basic Elaborate Icons</h4>
                            <h6 class="card-subtitle">Use <code>linea-elaborate</code> class like :<code> &lt;div data-icon="a" class="linea-icon linea-elaborate"&gt;&lt;div&gt; </code></h6>
                            <ul class="glyphs character-mapping">
                                <li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Ecommerece Icons</h4>
                            <h6 class="card-subtitle">Use <code>linea-ecommerce</code> class like :<code> &lt;div data-icon="a" class="linea-icon linea-ecommerce"&gt;&lt;div&gt; </code></h6>
                            <ul class="glyphs character-mapping">
                                <li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Software Icons</h4>
                            <h6 class="card-subtitle">Use <code>linea-software</code> class like :<code> &lt;div data-icon="a" class="linea-icon linea-software"&gt;&lt;div&gt; </code></h6>
                            <ul class="glyphs character-mapping">
                                <li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Weather Icons</h4>
                            <h6 class="card-subtitle">Use <code>linea-weather</code> class like :<code> &lt;div data-icon="a" class="linea-icon linea-weather"&gt;&lt;div&gt; </code></h6>
                            <ul class="glyphs character-mapping">
                                <li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Music Icons</h4>
                            <h6 class="card-subtitle">Use <code>linea-music</code> class like :<code> &lt;div data-icon="a" class="linea-icon linea-music"&gt;&lt;div&gt; </code></h6>
                            <ul class="glyphs character-mapping">
                                <li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Aerrow Icons</h4>
                            <h6 class="card-subtitle">Use <code>linea-aerrow</code> class like :<code> &lt;div data-icon="a" class="linea-icon linea-aerrow"&gt;&lt;div&gt; </code></h6>
                            <ul class="glyphs character-mapping">
                                <li>
