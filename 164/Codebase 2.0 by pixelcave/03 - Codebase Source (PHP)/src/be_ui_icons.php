...
<div class="content">
    <!-- Search Section -->
    <!-- Icon search functionality initialized in js/pages/be_ui_icons.js -->
    <form class="push" action="be_ui_icons.php" method="post" onsubmit="return false;">
...
<!-- Page JS Code -->
<?php $cb->get_js('js/pages/be_ui_icons.js'); ?>
