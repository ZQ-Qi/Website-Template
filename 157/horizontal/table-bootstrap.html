                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table data-toggle="table" data-url="../assets/plugins/bootstrap-table/bootstrap-test.json" data-click-to-select="true" data-select-item-name="myRadioName" data-height="295">
                                    <thead>
                                        <tr>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table data-toggle="table" data-url="../assets/plugins/bootstrap-table/bootstrap-test.json" data-click-to-select="true" data-height="295">
                                    <thead>
                                        <tr>
