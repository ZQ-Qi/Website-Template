    ...
    <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
      <table style="width: 100%;">
        ...
        <h1 style="margin-top: 0px;">
          Payment due date coming
        </h1>
        <div style="color: #636363; font-size: 14px; margin-bottom: 30px">
          Hi John, Hope you're doing well. You're enrolled in automatic payments, so we'll be debiting your bank account to make your monthly payment.
        </div>
          ...
          <table style="border-collapse: collapse; width: 100%;">
            ...
            <tr>
              ...
              <td style="padding: 20px 10px 20px 40px; color: #111; border-left: 1px solid #e7e7e7; ">
                <a href="#" style="padding: 8px 15px; background-color: #4B72FA; color: #fff; font-weight: bolder; font-size: 14px; display: inline-block; margin-right: 20px; text-decoration: none; white-space: nowrap;">Make Payment</a>
              </td>
            </tr>
          </table>
          <div style="color: #B8B8B8; font-size: 12px; padding: 30px; border-top: 1px solid #e7e7e7;">
            Did you know that you can manage your payments online? Make an extra payment, pay off your loan, or change your due date right from your account. Simply log in to your Account Summary and click Manage Payments or <a href="#">contact us</a> for additional support.
          </div>
        </div>
