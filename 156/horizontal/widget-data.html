        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Widget Data</h3>
                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="social-widget">
                                        <div class="soc-header box-facebook"><i class="fa fa-facebook"></i></div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="row">
                                <div class="col-12">
                                    <div class="social-widget">
                                        <div class="soc-header box-twitter"><i class="fa fa-twitter"></i></div>
                                        <div class="soc-content">
                                            <div class="col-6 b-r">
                                                <h3 class="font-medium">456</h3>
                                                <h5 class="text-muted">Followers</h5></div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="row">
                                <div class="col-12">
                                    <div class="social-widget">
                                        <div class="soc-header box-google"><i class="fa fa-google-plus"></i></div>
                                        <div class="soc-content">
                                            <div class="col-6 b-r">
                                                <h3 class="font-medium">456</h3>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="row">
                                <div class="col-12">
                                    <div class="social-widget">
                                        <div class="soc-header box-linkedin"><i class="fa fa-linkedin"></i></div>
                                        <div class="soc-content">
                                            <div class="col-6 b-r">
                                                <h3 class="font-medium">456</h3>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card card-inverse card-primary">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">$9432</h6>
                                <div id="spark4"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card card-inverse card-warning">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Dily Sales</h4>
                                <h6 class="card-subtitle">$9432</h6>
                                <div id="spark7"></div>
                            </div>
                        </div>
