        ...
        <div class="body">
            ...
            <div class="content">
                ...
                <div class="page-header">
                    ...
                    <h1>Form Grid <small>METRO STYLE ADMIN PANEL</small></h1>
                </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="block-fluid">                
                        <div class="row-form">
                            <div class="span6"><span class="top">span6</span><input type="text"/></div>
                            <div class="span6"><span class="top">span6</span><input type="text"/></div>                    
                        </div>
                        <div class="row-form">
                            <div class="span7"><span class="top">span7</span><input type="text"/></div>
                            <div class="span5"><span class="top">span5</span><input type="text"/></div>                    
                        </div>                                
                        <div class="row-form">
                            <div class="span8"><span class="top">span8</span><input type="text"/></div>
                            <div class="span4"><span class="top">span4</span><input type="text"/></div>                    
                        </div>                               
                        <div class="row-form">
                            <div class="span9"><span class="top">span9</span><input type="text"/></div>
                            <div class="span3"><span class="top">span3</span><input type="text"/></div>                    
                        </div>                
                        <div class="row-form">
                            <div class="span10"><span class="top">span10</span><input type="text"/></div>
                            <div class="span2"><span class="top">span2</span><input type="text"/></div>                    
                        </div>                                
                        <div class="row-form">
                            <div class="span11"><span class="top">span11</span><input type="text"/></div>
                            <div class="span1"><span class="top">span1</span><input type="text"/></div>                    
                        </div>                                                
                        <div class="row-form">
                            <div class="span12"><span class="top">span12</span><input type="text"/></div>                    
                        </div>                                                                
                    </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="block-fluid">                
                        <div class="row-form">
                            <div class="span1 offset5"><span class="top">span1 offset5</span><input type="text"/></div>
                            <div class="span1"><span class="top">span1</span><input type="text"/></div>
                        </div>
                        <div class="row-form">
                            <div class="span2 offset4"><span class="top">span2 offset4</span><input type="text"/></div>
                            <div class="span2"><span class="top">span2</span><input type="text"/></div>                    
                        </div>                                
                        <div class="row-form">
                            <div class="span3 offset3"><span class="top">span3 offset3</span><input type="text"/></div>
                            <div class="span3"><span class="top">span3</span><input type="text"/></div>                    
                        </div>                               
                        <div class="row-form">
                            <div class="span4 offset2"><span class="top">span4 offset2</span><input type="text"/></div>
                            <div class="span4"><span class="top">span4</span><input type="text"/></div>                    
                        </div>                
                        <div class="row-form">
                            <div class="span5 offset1"><span class="top">span5 offset1</span><input type="text"/></div>
                            <div class="span5"><span class="top">span5</span><input type="text"/></div>                    
                        </div>                
                        <div class="row-form">
                            <div class="span6"><span class="top">span6</span><input type="text"/></div>
                        ...
                        <div class="row-form">
                            <div class="span5"><span class="top">span5</span><input type="text"/></div>
                            <div class="span5 offset2"><span class="top">span5 offset2</span><input type="text"/></div>
                        </div>
                        <div class="row-form">
                            <div class="span4"><span class="top">span4</span><input type="text"/></div>
                            <div class="span4 offset4"><span class="top">span4 offset4</span><input type="text"/></div>
                        </div>  
                        <div class="row-form">
                            <div class="span3"><span class="top">span3</span><input type="text"/></div>
                            <div class="span3 offset6"><span class="top">span3 offset6</span><input type="text"/></div>
                        </div>       
                        <div class="row-form">
                            <div class="span2"><span class="top">span2</span><input type="text"/></div>
                            <div class="span2 offset8"><span class="top">span2 offset8</span><input type="text"/></div>
                        </div>      
                        <div class="row-form">
                            <div class="span1"><span class="top">span1</span><input type="text"/></div>
                            <div class="span1 offset10"><span class="top">span1 offset10</span><input type="text"/></div>
                        </div>                
                    </div>
