...
<head>
    ...
    <title>Webstrot Admin : Teacher Details</title>
                                                        ...
                                                        <div role="tabpanel" class="tab-pane active" id="1">
                                                            <div class="contact-information">
                                                                ...
                                                                <div class="phone-content">
                                                                    ...
                                                                    <span class="phone-number">+91 123456789</span>
                                                                </div>
                                                                ...
                                                                <div class="email-content">
                                                                    <span class="contact-title">Subject</span>
                                                                    <span class="contact-email">English</span>
                                                                </div>
                                                                <div class="email-content">
                                                                    <span class="contact-title">Section</span>
                                                                    <span class="contact-email">A</span>
                                                                </div>
                                                                <div class="email-content">
                                                                    <span class="contact-title">Class</span>
                                                                    <span class="contact-email">3</span>
                                                                </div>
                                                                <div class="email-content">
                                                                    <span class="contact-title">ID:</span>
                                                                    <span class="contact-email">#2017</span>
                                                                </div>
                                                                <div class="email-content">
                                                                    <span class="contact-title">Phone</span>
                                                                    <span class="contact-email">+8548390</span>
                                                                </div>
                                                                <div class="email-content">
                                                                    <span class="contact-title">Joining Date:</span>
                                                                    <span class="contact-email">20/05/2017</span>
                                                                </div>
                                                                <div class="address-content">
                                                                    <span class="contact-title">Address:</span>
                                                                    <span class="mail-address">Road#45,House#12,Canada</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
