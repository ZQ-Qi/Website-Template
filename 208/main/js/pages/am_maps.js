...
var amChartsMapsDemo = function() {
    ...
    var demo1 = function() {
         ...
         * Create the map
         */
        var map = AmCharts.makeChart("lion_amcharts_1", {
            "type": "map",
            "theme": "dark",
    ...
    var demo2 = function() {
        ...
        var map = AmCharts.makeChart("lion_amcharts_2", {
            "type": "map",
            "theme": "dark",
            "dataProvider": {
                "map": "worldLow",
    ...
    var demo3 = function() {
        var map = AmCharts.makeChart("lion_amcharts_3", {
    ...
    var demo4 = function() {
         ...
         * Create the map
         */
        var map = AmCharts.makeChart("lion_amcharts_4", {
            "type": "map",
            "theme": "dark",
            "dataProvider": {
                "map": "worldLow",
    ...
    var demo5 = function() {
        var map = AmCharts.makeChart("lion_amcharts_5", {
            "type": "map",
            "theme": "dark",
            "dataProvider": {
                "map": "worldHigh",
    ...
    var demo6 = function() {
        var map = AmCharts.makeChart("lion_amcharts_6", {
            "type": "map",
            "theme": "dark",
            "colorSteps": 10,
