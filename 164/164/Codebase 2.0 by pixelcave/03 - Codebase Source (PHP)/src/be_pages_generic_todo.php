...
<div class="content">
    ...
    <div class="block block-rounded">
        <div class="block-content bg-pattern" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/various/bg-pattern-inverse.png');">
...
<!-- Page JS Code -->
<?php $cb->get_js('js/pages/be_pages_generic_todo.js'); ?>
