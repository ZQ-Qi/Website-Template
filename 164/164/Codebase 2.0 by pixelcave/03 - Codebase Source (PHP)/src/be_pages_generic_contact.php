...
<div class="bg-primary">
    <div class="bg-pattern bg-black-op-25" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/various/bg-pattern.png');">
...
<!-- Page JS Code -->
<?php $cb->get_js('js/pages/be_pages_generic_contact.js'); ?>
