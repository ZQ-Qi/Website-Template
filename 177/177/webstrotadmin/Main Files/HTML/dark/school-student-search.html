...
<head>
    ...
    <title>Webstrot Admin : Student Search </title>
                        ...
                        <div class="card alert">
                            <div class="card-body">
                                <div class="card-header m-b-20">
                                    <h4>Search Student Promotion</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            <label>Promotion Form Class</label>
                            ...
                            <button class="btn btn-default btn-lg m-b-10 bg-warning border-none m-r-5 sbmt-btn" type="button">Search</button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
