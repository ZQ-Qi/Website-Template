...
<head>
    ...
    <title>Webstrot Admin : New Subject Create</title>
                                ...
                                <div class="card-header pr">
                                    ...
                                    <div class="search-action">
                                        <div class="search-type dib">
                                            <input class="form-control input-rounded" placeholder="#Code type here..." type="text">
                                        </div>
                                        <div class="search-type dib">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table student-data-table m-t-20">
                                            <thead>
                                                <tr>
                                                    <th><label><input type="checkbox" value=""></label>Subject Code</th>
                                                    <th>Subject Name</th>
                                                    <th>Subject Type</th>
                                                    <th>Class</th>
                                                    <th>Action</th>
