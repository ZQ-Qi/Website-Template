        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Cards</h3>
                </div>
    ...
    <span class="nt">&lt;/div&gt;</span></code>
                ...
                <div class="row">
                    <div class="col-12 m-t-30">
                        ...
                        <p class="text-muted m-t-0 font-12">Add an optional header and/or footer within a card. <code class="btn btn-sm" href="#code2" data-toggle="collapse">HTML <i class="fa fa-code"></i></code></p>
