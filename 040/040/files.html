...
<head>        
    ...
    <![endif]-->                
    <title>File handling - Aries Premium Admin Template</title>
        ...
        <div class="sidebar">
            ...
            <ul class="navigation">            
                ...
                <li class="active">
                    ...
                    <div class="open"></div>
                    <ul>
                        <li class="active"><a href="files.html">File handling</a></li>
        ...
        <div class="body">
            ...
            <div class="content">
                ...
                <div class="page-header">
                    ...
                    <h1>File handling <small>METRO STYLE ADMIN PANEL</small></h1>
                </div>
