...
<head>
    ...
    <title>Webstrot Admin : Comments</title>
...
<body>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">UI-Recent-Comments</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="recent-comment">
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img class="media-object" src="assets/images/user-1.png" alt="..."></a>
                                        </div>
    ...
    <script src="assets/js/lib/chart-js/custom-chart-js.js"></script>
