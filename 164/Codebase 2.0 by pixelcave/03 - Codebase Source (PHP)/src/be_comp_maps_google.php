...
<!-- Page Content -->
<div class="content">
    <!-- Maps and Search functionality is initialized in js/pages/be_comp_maps_google.js, for more examples you can check out https://hpneo.github.io/gmaps/ -->
    ...
    <div class="block">
        ...
        <div id="js-map-street" style="height: 500px;"></div>
    </div>
    <!-- END Street Map -->
</div>
<!-- END Page Content -->
...
<!-- Page JS Code -->
<?php $cb->get_js('js/pages/be_comp_maps_google.js'); ?>
