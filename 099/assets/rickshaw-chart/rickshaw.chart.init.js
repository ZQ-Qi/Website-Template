...
!function($) {
    ...
    RickshawChart.prototype.init = function() {
      ...
      var multicolors = ['rgba(235, 193, 66, 0.4)','rgba(3, 169, 244, 0.4)','rgba(0, 150, 136, 0.4)','rgba(97, 92, 168, 0.6)','rgba(20, 8, 45, 0.6)'];
