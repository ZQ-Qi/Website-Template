        ...
        <div class="row items-push img-fluid-100">
            <div class="col-sm-6 col-md-3" data-category="logo">
                <a class="img-link" href="be_pages_generic_project.php">
                    <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/various/cb-project-promo1.png" alt="Project 1 Promo">
                </a>
            </div>
            <div class="col-sm-6 col-md-3" data-category="webapp">
                <a class="img-link" href="be_pages_generic_project.php">
                    <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/various/cb-project-promo2.png" alt="Project 2 Promo">
                </a>
            </div>
            <div class="col-sm-6 col-md-3" data-category="logo">
                <a class="img-link" href="be_pages_generic_project.php">
                    <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/various/cb-project-promo3.png" alt="Project 3 Promo">
                </a>
            </div>
            <div class="col-sm-6 col-md-3" data-category="logo">
                <a class="img-link" href="be_pages_generic_project.php">
                    <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/various/cb-project-promo4.png" alt="Project 4 Promo">
                </a>
            </div>
            <div class="col-sm-6 col-md-3" data-category="webapp">
                <a class="img-link" href="be_pages_generic_project.php">
                    <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/various/cb-project-promo5.png" alt="Project 5 Promo">
                </a>
            </div>
            <div class="col-sm-6 col-md-3" data-category="logo">
                <a class="img-link" href="be_pages_generic_project.php">
                    <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/various/cb-project-promo6.png" alt="Project 6 Promo">
                </a>
            </div>
            <div class="col-sm-6 col-md-3" data-category="webapp">
                <a class="img-link" href="be_pages_generic_project.php">
                    <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/various/cb-project-promo2.png" alt="Project 7 Promo">
                </a>
            </div>
            <div class="col-sm-6 col-md-3" data-category="photography">
                <a class="img-link" href="be_pages_generic_project.php">
                    <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/various/cb-project-promo1.png" alt="Project 8 Promo">
                </a>
            </div>
            <div class="col-sm-6 col-md-3" data-category="logo">
                <a class="img-link" href="be_pages_generic_project.php">
                    <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/various/cb-project-promo4.png" alt="Project 9 Promo">
                </a>
            </div>
            <div class="col-sm-6 col-md-3" data-category="webapp">
                <a class="img-link" href="be_pages_generic_project.php">
                    <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/various/cb-project-promo1.png" alt="Project 10 Promo">
                </a>
            </div>
            <div class="col-sm-6 col-md-3" data-category="photography">
                <a class="img-link" href="be_pages_generic_project.php">
                    <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/various/cb-project-promo5.png" alt="Project 11 Promo">
                </a>
            </div>
            <div class="col-sm-6 col-md-3" data-category="webapp">
                <a class="img-link" href="be_pages_generic_project.php">
                    <img class="img-fluid img-thumb" src="<?php echo $cb->assets_folder; ?>/img/various/cb-project-promo3.png" alt="Project 12 Promo">
                </a>
            </div>
        </div>
        <!-- END Projects -->
