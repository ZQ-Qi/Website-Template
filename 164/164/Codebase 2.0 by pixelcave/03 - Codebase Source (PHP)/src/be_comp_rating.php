...
<!-- Page Content -->
<div class="content">
    <!-- Rating functionality is initialized in js/pages/be_comp_rating.js, for more examples you can check out https://github.com/wbotelhos/raty -->
...
<!-- Page Plugins -->
<?php $cb->get_js('js/plugins/jquery-raty/jquery.raty.min.js'); ?>

<!-- Page JS Code -->
<?php $cb->get_js('js/pages/be_comp_rating.js'); ?>
