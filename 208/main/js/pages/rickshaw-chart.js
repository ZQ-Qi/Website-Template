    ...
    "use strict";
        ...
        (function() {
            ...
            var graph = new Rickshaw.Graph({
                ...
                series: [{
                    data: seriesData[0],
                    color: '#ff4c52', // Get Pages contextual color
                    name: 'DB Server'
                }, {
                    data: seriesData[1],
                    color: '#0bb2d4', // Get Pages contextual color
                    name: 'Web Server'
                }]
            });
        ...
        (function() {
            ...
            var graph = new Rickshaw.Graph({
                ...
                series: [{
                    data: seriesData[0],
                    color: '#3e8ef7', // Get Pages contextual color
                    name: "New users"
                }, {
                    data: seriesData[1],
                    color: '#ffd600', // Get Pages contextual color
        ...
        (function() {
            ...
            var graph = new Rickshaw.Graph({
                ...
                series: [{
                    ...
                    color: '#17b3a3', // Get Pages contextual color
                    opacity: 0,
                    renderer: 'stack'
                }]
            });
