...
<div class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-xl-3">
            <a class="block block-rounded block-link-pop text-center" href="javascript:void(0)">
                <div class="block-content block-content-full bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo30.jpg');">
                    <?php $cb->get_avatar('', 'female', 64, 'img-thumb'); ?>
                </div>
                <div class="block-content block-content-full">
                    <div class="font-w600 mb-5"><?php $cb->get_name('female'); ?></div>
        ...
        <div class="col-md-6 col-xl-3">
            <a class="block block-rounded block-link-pop text-center" href="javascript:void(0)">
                <div class="block-content block-content-full bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo4.jpg');">
                    <?php $cb->get_avatar('', 'female', 64, 'img-thumb'); ?>
                </div>
                <div class="block-content block-content-full">
                    <div class="font-w600 mb-5"><?php $cb->get_name('female'); ?></div>
        ...
        <div class="col-md-6 col-xl-3">
            <a class="block block-rounded block-link-pop text-center" href="javascript:void(0)">
                <div class="block-content block-content-full bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo25.jpg');">
                    <?php $cb->get_avatar('', 'male', 64, 'img-thumb'); ?>
                </div>
                <div class="block-content block-content-full">
                    <div class="font-w600 mb-5"><?php $cb->get_name('male'); ?></div>
        ...
        <div class="col-md-6 col-xl-3">
            <a class="block block-rounded block-link-pop text-center" href="javascript:void(0)">
                <div class="block-content block-content-full bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo1.jpg');">
                    <?php $cb->get_avatar('', 'male', 64, 'img-thumb'); ?>
                </div>
                <div class="block-content block-content-full">
                    <div class="font-w600 mb-5"><?php $cb->get_name('male'); ?></div>
    ...
    <div class="row">
        <!-- Row #2 -->
        <div class="col-md-6 col-xl-3">
            <a class="block block-rounded block-transparent text-center bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo22.jpg');" href="javascript:void(0)">
                <div class="block-content block-content-full">
                    <?php $cb->get_avatar('', 'female', 64, 'img-thumb'); ?>
                </div>
        ...
        <div class="col-md-6 col-xl-3">
            <a class="block block-rounded block-transparent text-center bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo17.jpg');" href="javascript:void(0)">
                <div class="block-content block-content-full">
                    <?php $cb->get_avatar('', 'female', 64, 'img-thumb'); ?>
                </div>
                <div class="block-content block-content-full block-content-sm bg-black-op">
        ...
        <div class="col-md-6 col-xl-3">
            <a class="block block-rounded block-transparent text-center bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo9.jpg');" href="javascript:void(0)">
                <div class="block-content block-content-full">
                    <?php $cb->get_avatar('', 'male', 64, 'img-thumb'); ?>
                </div>
                <div class="block-content block-content-full block-content-sm bg-black-op">
        ...
        <div class="col-md-6 col-xl-3">
            <a class="block block-rounded block-transparent text-center bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo2.jpg');" href="javascript:void(0)">
                <div class="block-content block-content-full">
                    <?php $cb->get_avatar('', 'male', 64, 'img-thumb'); ?>
                </div>
                <div class="block-content block-content-full block-content-sm bg-black-op">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-xl-3">
            <a class="block block-rounded block-link-shadow text-center" href="javascript:void(0)">
                ...
                <div class="block-content block-content-full bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo28.jpg');">
                    <?php $cb->get_avatar('', 'female', 64, 'img-thumb'); ?>
                </div>
                <div class="block-content block-content-full block-content-sm bg-elegance">
        ...
        <div class="col-md-6 col-xl-3">
            <a class="block block-rounded block-link-shadow text-center" href="javascript:void(0)">
                ...
                <div class="block-content block-content-full bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo23.jpg');">
                    <?php $cb->get_avatar('', 'female', 64, 'img-thumb'); ?>
                </div>
        ...
        <div class="col-md-6 col-xl-3">
            <a class="block block-rounded block-link-shadow text-center" href="javascript:void(0)">
                ...
                <div class="block-content block-content-full bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo26.jpg');">
                    <?php $cb->get_avatar('', 'male', 64, 'img-thumb'); ?>
                </div>
                <div class="block-content block-content-full block-content-sm bg-pulse">
        ...
        <div class="col-md-6 col-xl-3">
            <a class="block block-rounded block-link-shadow text-center" href="javascript:void(0)">
                ...
                <div class="block-content block-content-full bg-image" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/photos/photo12.jpg');">
                    <?php $cb->get_avatar('', 'male', 64, 'img-thumb'); ?>
                </div>
                <div class="block-content block-content-full block-content-sm bg-primary">
