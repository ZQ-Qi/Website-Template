// Darken a color
	  ...
	  colors:
            ["#00e682", "#2b88ff", "#ff2b88", "#ffa22b", "#00eeff", "#ff382b", "#382bff",
             "#8e2de2", "#6fff00", "#00e682", "#2b88ff", "#ff2b88", "#ffa22b", "#00eeff",
             "#ff382b", "#382bff", "#8e2de2"];
      ...
      function candlePlotter(e) {
        ...
        for (p = 0 ; p < prices.length; p++) {
          ...
          if (price.open > price.close) {
            ctx.fillStyle ='rgba(255,43,136,0.5)';
            bodyY = area.h * price.openY + area.y;
          }
          else {
            ctx.fillStyle ='rgba(255,43,136,1.0)';
