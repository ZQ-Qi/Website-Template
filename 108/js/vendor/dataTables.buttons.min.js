...
(function(d) {
    ...
    d.extend(l.prototype, {
        ...
        _constructor: function() {
            ...
            for (var g = 0,
            h = e.length; g < h; g++) this.add(e[g]);
            b.on("destroy",
            function(b, e) {
                e === c && a.destroy()
            });
            d("body").on("keyup." + this.s.namespace,
            function(b) {
        ...
        _draw: function(a, b) {
            ...
            a.children().detach();
            for (var c = 0,
            e = b.length; c < e; c++) a.append(b[c].inserter),
            a.append(" "),
        ...
        _expandButton: function(a, b, c, e) {
            ...
            b = !d.isArray(b) ? [b] : b, f = 0, q = b.length; f < q; f++) {
                ...
                if (j) if (d.isArray(j)) this._expandButton(a, j, c, e);
                else {
        ...
        _buildButton: function(a, b) {
            ...
            g = a.tag || c.tag,
            j = d("<" + g + "/>").addClass(c.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb",
            function(b) {
                b.preventDefault(); ! j.hasClass(c.disabled) && a.action && q(b, h, j, a);
                j.blur()
            }).on("keyup.dtb",
            function(b) {
            ...
            e.tag ? (g = d("<" + e.tag + "/>").html(f(a.text)).addClass(e.className), "a" === e.tag.toLowerCase() && g.attr("href", "#"), j.append(g)) : j.html(f(a.text)); ! 1 === a.enabled && j.addClass(c.disabled);
            ...
            if (!b._buttonsHandled) {
                var c = function(e) {
                    ...
                    h = e.length; g < h; g++) {
                        var f = e[g].conf,
                        q = e[g].node;
                        if (f.key) if (f.key === a) b._buttonsHandled = !0,
                        d(q).click();
                        else if (d.isPlainObject(f.key) && f.key.key === a && (!f.key.shiftKey || b.shiftKey)) if (!f.key.altKey || b.altKey) if (!f.key.ctrlKey || b.ctrlKey) if (!f.key.metaKey || b.metaKey) b._buttonsHandled = !0,
                        d(q).click();
    ...
    l.background = function(a, b, c) {
        c === m && (c = 400);
        a ? d("<div/>").addClass(b).css("display", "none").appendTo("body").fadeIn(c) : d("body > div." + b).fadeOut(c,
        function() {
    ...
    l.instanceSelector = function(a, b) {
        ...
        g = function(a) {
            if (d.isArray(a)) for (var f = 0,
            q = a.length; f < q; f++) g(a[f]);
    ...
    l.buttonSelector = function(a, b) {
        for (var c = [], e = function(a, b, c) {
            for (var d, g, f = 0,
            h = b.length; f < h; f++) if (d = b[f]) g = c !== m ? c + f: f + "",
            a.push({
                node: d.node,
                name: d.conf.name,
                idx: g
        ...
        collection: {
            ...
            action: function(a, b, c, e) {
                ...
                setTimeout(function() {
                    ...
                    if (e.autoClose) b.on("buttons-action.b-internal",
                    function() {
                        j()
                    })
                },
    ...
    i.Api.register("buttons()",
    function(a, b) {
        b === m && (b = a, a = m);
        this.selector.buttonGroup = a;
        var c = this.iterator(!0, "table",
        function(c) {
    ...
    i.Api.registerPlural("buttons().active()", "button().active()",
    function(a) {
    ...
    i.Api.registerPlural("buttons().action()", "button().action()",
    function(a) {
        return a === m ? this.map(function(a) {
    ...
    i.Api.register(["buttons().disable()", "button().disable()"],
    function() {
        return this.each(function(a) {
            a.inst.disable(a.node)
        })
    });
    i.Api.registerPlural("buttons().nodes()", "button().node()",
    function() {
        var a = d();
    ...
    i.Api.registerPlural("buttons().processing()", "button().processing()",
    function(a) {
        return a === m ? this.map(function(a) {
    ...
    i.Api.registerPlural("buttons().text()", "button().text()",
    function(a) {
        return a === m ? this.map(function(a) {
    ...
    i.Api.registerPlural("buttons().trigger()", "button().trigger()",
    function() {
        return this.each(function(a) {
    ...
    i.Api.registerPlural("buttons().remove()", "buttons().remove()",
    function() {
    ...
    i.Api.register("buttons.exportData()",
    function(a) {
        if (this.context.length) {
            ...
            for (var h = b.rows(c.rows, h).indexes().toArray(), f = b.cells(h, c.columns), h = f.render(c.orthogonal).toArray(), f = f.nodes().toArray(), k = a.length, j = [], l = 0, n = 0, o = 0 < k ? h.length / k: 0; n < o; n++) {
                for (var r = [k], s = 0; s < k; s++) r[s] = c.format.body(h[l], n, s, f[l]),
                l++;
                j[n] = r
            }
            a = {
    ...
    i.Api.register("buttons.exportInfo()",
    function(a) {
        a || (a = {});
        var b;
        var c = a;
